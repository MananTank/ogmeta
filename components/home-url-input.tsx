...
export interface HomeUrlInputHandle {
  saveToHistory: (urlToSave: string, favicon?: string) => Promise<void>
}
...
export const HomeUrlInput = forwardRef<HomeUrlInputHandle, HomeUrlInputProps>(
  function HomeUrlInput(
    { defaultUrl, prefix, inputClassName, onStateChange },
    ref
  ) {
    ...
    useImperativeHandle(ref, () => ({ saveToHistory }), [saveToHistory])
